...
<body data-bs-theme="dark">
	...
	<div class="container mt-3">
		...
		<ul>
			...
			<li><b>Setup:</b> <a href="https://openwf.io/supplementals/client%20drop-in/download_latest" target="_blank">Download the Bootstrapper</a> and put it in your game's installation folder (the one where Warframe.x64.exe is in). On Linux, sideloading only seems to work when the DLL is called dwmapi.dll, which only works in U29 and above. Alternatively, you can force sideloading using <code>WINEDLLOVERRIDES="wtsapi32.dll=n,b" wine Warframe.x64.exe</code> or similar.</li>
