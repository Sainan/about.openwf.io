...
<body data-bs-theme="dark">
	...
	<div class="container mt-3">
		...
		<p>To use OpenWF, you only need to <a href="/supplementals/client%20drop-in/<?=$dll_version;?>/dwmapi.dll" download="wtsapi32.dll">download the DLL</a> and put it in your game's installation folder (the one where Warframe.x64.exe is in).</p>
		<ul>
