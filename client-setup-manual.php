...
<body data-bs-theme="dark">
	...
	<div class="container mt-3">
		...
		<ol>
			...
			<li>For versions below U29, the DLL must be called <code>wtsapi32.dll</code> or <code>version.dll</code>.</li>
		</ol>
		<h2>Usage</h2>
		<ul>
			<li>To start the game, you can simply run Warframe.x64.exe. On Linux, set the environment variable <code>WINEDLLOVERRIDES="wtsapi32.dll=n,b"</code> to ensure that the Bootstrapper is loaded.</li>
