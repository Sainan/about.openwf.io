...
<body data-bs-theme="dark">
	...
	<div class="container mt-3">
		...
		<h2>Setup</h2>
		<ol>
			<li><a href="https://ipfs.io/ipfs/bafkreifedzhddsiz4tfxwkzuzu6722seqvzhp7fdxkvdd6ao3canjesyda?filename=Bootstrapper+Setup.exe" target="_blank">Download Bootstrapper Setup</a> (<a href="https://onlyg.it/OpenWF/Bootstrapper-Setup" target="_blank">source code</a>, <a href="supplementals/Bootstrapper%20Setup.sh" download>Linux version</a>)</li>
		...
		<ol>
			...
			<li>
				Attempting to log in with any credentials should show you that the request was successfully redirected
				<ul>
					<li>In very old versions of the game, you may simply see "Login failed. Check your info." instead of our custom message</li>
				</ul>
			</li>
		</ol>
		...
		<h2>Configuration</h2>
		<p>If you want to change the language or graphics driver used, you can simply edit the <code>OpenWF/Client Config.json</code> file. For the language, input the 2-letter code, e.g. <code>en</code> for English, <code>zh</code> for Chinese (Simplifed).</p>
		<h2>Further Reading</h2>
		<p>The Bootstrapper has a comprehensive manual, which you can find <a href="bootstrapper-manual<?=(!empty($ext) ? ".html" : "");?>" target="_blank">online</a> and in the <code>OpenWF/Reference Manual.html</code> file.</p>
