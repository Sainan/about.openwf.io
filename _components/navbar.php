		...
		<div class="collapse navbar-collapse" id="navbar-content">
			<ul class="navbar-nav me-auto mb-0">
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle<?=(($path == "/client-setup" || $path == "/web-server-setup" || $path == "/import" || $path == "/chat-server-setup" || $path == "/hub-server-setup" || $path == "/dockerized-server-setup" || $path == "/asset-replacements-guide") ? " active" : ""); ?>" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Guides</a>
