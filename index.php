...
<body data-bs-theme="dark">
	...
	<div class="container mt-3">
		...
		<h3>Software</h3>
		<ul>
			<li><b>SpaceNinjaServer</b> is a customizable, <a href="https://onlyg.it/OpenWF/SpaceNinjaServer" target="_blank">open-source</a> reimplementation of the game's web services.</li>
